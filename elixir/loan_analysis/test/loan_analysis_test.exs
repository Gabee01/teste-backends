defmodule LoanAnalysisTest do
  ...
  alias LoanAnalysis.{Event, Proposal, Proposals, Helper}

  test "messages read from file" do
    assert 20 == (
      Helper.read_file("../../test/input/input001.txt")
      |> length)
  end
  ...
  test "proposal is valid" do
    LoanAnalysis.init_state()
    "c2d06c4f-e1dc-4b2a-af61-ba15bc6d8610,proposal,created,2019-11-11T13:26:04Z,bd6abe95-7c44-41a4-92d0-edf4978c9f4e,684397.0,72" |> Event.process

    "27179730-5a3a-464d-8f1e-a742d00b3dd3,warranty,added,2019-11-11T13:26:04Z,bd6abe95-7c44-41a4-92d0-edf4978c9f4e,6b5fc3f9-bb6b-4145-9891-c7e71aa87ca2,1967835.53,ES" |> Event.process

    "716de46f-9cc0-40be-b665-b0d47841db4c,warranty,added,2019-11-11T13:26:04Z,bd6abe95-7c44-41a4-92d0-edf4978c9f4e,1750dfe8-fac7-4913-b946-ab538dce0977,1608429.56,GO" |> Event.process

    "05588a09-3268-464f-8bc8-03974303332a,proponent,added,2019-11-11T13:26:04Z,bd6abe95-7c44-41a4-92d0-edf4978c9f4e,5f9b96d2-b8db-48a8-a28b-f7ac9b3c8108,Kip Beer,50,73300.95,true" |> Event.process

    "0fe9465f-af17-452c-9abe-fa64d475d8ad,proponent,added,2019-11-11T13:26:04Z,bd6abe95-7c44-41a4-92d0-edf4978c9f4e,fc1a95db-5468-4a37-9a49-9b15b9e250e6,Dong McDermott,50,67287.16,false" |> Event.process
  ...
  test "proposal is not valid" do
    ...
    |> Event.process
    |> IO.inspect()
    {return, reason} = LoanAnalysis.validate_proposal("bd6abe95-7c44-41a4-92d0-edf4978c9f4e")
    assert  return == :error
  end
end
